...
urlpatterns = [
    ...
    re_path(r"^api/v1/", include("learning.urls")),
    ...
    re_path(r"^courses$", views.lms_courses_catalog, name="lms_courses_catalog"),
    re_path(r"^courses/(?P<slug>[\w-]+)$", views.lms_course_detail, name="lms_course_detail"),
    re_path(
        r"^teach/(?P<slug>[\w-]+)/certificates$",
        views.lms_teach_certificates,
        name="lms_teach_certificates",
    ),
    re_path(r"^teach/(?P<slug>[\w-]+)$", views.lms_teach, name="lms_teach"),
    re_path(r"^learning-paths$", views.lms_learning_paths, name="lms_learning_paths"),
    re_path(r"^learning-paths/(?P<slug>[\w-]+)$", views.lms_learning_path_detail, name="lms_learning_path_detail"),
    re_path(r"^learn/(?P<slug>[\w-]+)$", views.lms_learn, name="lms_learn"),
    re_path(r"^my/learning$", views.lms_my_learning, name="lms_my_learning"),
    re_path(r"^my/calendar$", views.lms_my_calendar, name="lms_my_calendar"),
    re_path(r"^my/credentials$", views.lms_my_credentials, name="lms_my_credentials"),
    re_path(r"^my/teaching$", views.lms_my_teaching, name="lms_my_teaching"),
    re_path(r"^my/org/learning$", views.lms_org_learning, name="lms_org_learning"),
